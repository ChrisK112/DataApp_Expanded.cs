            ...
            try
            {
                ...
                {                    
                    ...
                    foreach (DataRow row_import in dataset.Tables[dataInUse].Rows)
                    {
                        ...
                        if(comboBox_DataMapper_PersonRef.Text != "" && radioButton1_DataMapper_RecordType.Checked)
                        {
                        ...
                        else if (comboBox_DataMapper_PersonRef.Text == "" && radioButton1_DataMapper_RecordType.Checked)
                        {
                               continue;
                        ...
                        if (comboBox_DataMapper_Country.Text != "")
                        {
                            ...
                            {
                                if(row_import.Field<string>(comboBox_DataMapper_Country.Text) == "UK" || row_import.Field<string>(comboBox_DataMapper_Country.Text) == "GB")
                                {
                                    row_export["Country"] = "United Kingdom";
                                }
                                else
