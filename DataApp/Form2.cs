...
namespace DataApp
{
    public partial class Form2 : Form
    {
        ...
        {
            InitializeComponent();
            temp_dt = DataHandler.FlatToDt(filepath, maxrownumber: 20);
        ...
        {
            delimiter_f2 = ';';
            temp_dt = DataHandler.FlatToDt(filepath, delimiter_f2, 20);
            dataGridView1_Form2.DataSource = temp_dt;
        }
        ...
        private void radioButton1_Form2_Other_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                delimiter_f2 = Convert.ToChar(textBox1_Form2_Other.Text);
                temp_dt = DataHandler.FlatToDt(Form1.sourceFile, delimiter_f2, 20);
                dataGridView1_Form2.DataSource = temp_dt;
            }
        }
